...
Public Class Vender
    ...
    End Sub
    '
    'Booton ADD Agrega el prod seleccionado a la lista de venta definitiva
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        ...
        If DataGridView1.Rows.Count > 0 Then
            ...
            If MessageBox.Show("Esta seguro de realizar la venta?", "Vender", MessageBoxButtons.YesNo, MessageBoxIcon.Information, MessageBoxDefaultButton.Button2) = DialogResult.Yes Then
                ...
                Dim fecha, hora, query, cliente, pro, det, query_update_stock, query_update_caja As String
                Dim total As Double
                ...
                query = "INSERT INTO [dbo].[Ventas]([Cli_ven],[Total_vendido],[Remito_ven],[Fecha_ven],[Hora_ven],[Detalle_Ven]) VALUES('" & cliente & "'," & total & "," & NRem & ",'" & fecha & "','" & hora & "','" & det & "')"
