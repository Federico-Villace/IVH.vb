...
Public Class Compras
    ...
    Private Sub btnConfirmar_Click(sender As Object, e As EventArgs) Handles btnConfirmar.Click
        Dim fecha, concepto, hora, queryInsertCompra, queryUpdateStock, queryUpdateCaja, queryInsertMovCaja, monto, prod As String
        ...
        concepto = "Egreso por Compra N°" & txtCod.Text
        id = Val(txtCod.Text)
        ...
        queryInsertMovCaja = "INSERT INTO [dbo].[MovExtras]([MONTO], [ING], [EGR], [FECHA], [HORA], [CONCEPTO]) VALUES ('" & monto & "','NO','SI','" & fecha & "','" & hora & "', '" & concepto & "')"
        Try
            'se ejecutan las consultas
            SQL_Accion(queryInsertCompra)
            SQL_Accion(queryUpdateCaja)
            SQL_Accion(queryUpdateStock)
            SQL_Accion(queryInsertMovCaja)
